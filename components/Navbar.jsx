...
function Navbar() {
  return (
    <div className=" flex items-center sticky z-[999] top-0 justify-between bg-[#d1411e]  shadow-md  h-28 md:px-10">
      <div className="relative">
        <div className="absolute p-2 w-10 h-10 rounded-full bg-white  ">
          <Image
        ...
        <div className="px-14  items-center font-medium text-white ">
